...
int main() {
    ...
    Logger default_logger(fmt, "Default Logger");
    ...
    Logger format_logger(fmt, "Format Logger");
    ...
    Logger duplicate_format_macros_logger(fmt, "Duplicate format macros Logger");
